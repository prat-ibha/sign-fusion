...
function Video() {
  ...
  useEffect(() => {
    ...
    if (idRef.current && params.videoId) {
      idRef.current.value = params.videoId;
    }
  }, [ref, bot, params.videoId]);
  ...
  const animateFromID = () => {
    ...
    const videoID = idRef.current.value;
    ...
    <div className='container-fluid'>
      <div className='row'>
        <div className='col-md-3'>
          ...
          <input ref={idRef} placeholder='Video ID' className='w-100 input-style' />
